...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "teammanager@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "teammanager API";

        private String description = "teammanager API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "teammanager";
